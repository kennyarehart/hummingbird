...
/**
 * Hummingbird can be used as a static library.
 * @namespace
 */
/**
 * An instance of a Hummingbird.
 * @class
 *
 * @constructor
 *
 * @property handler						The method called on each tick based on speed
 * @property speedIn						how to calculate lifeSpan; defaults to SECONDS
 * @property scope							What <code>this</code> will be on the handler
 * @property [lifeSpan=undefined]			Optional length of time the handler will be active
 * @property [lifeSpanIn=undefined]			Optional how to calculate lifeSpan; defaults to SECONDS
 * @property [onComplete=undefined]			Optional called when lifeSpan value is met
 * @property [onCompleteParams=undefined]	Optional params passed through onComplete
 */

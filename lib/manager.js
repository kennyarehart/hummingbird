...
export const enlist = (singleBird, skipFinalCheck) => {
    ...
    if (_isActive && !skipFinalCheck) wake('enlist')
...
function iterateConditional(a, b, ...args) {
